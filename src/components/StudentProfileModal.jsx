                ...
                >
                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            {/* Left Column - Percentage & Student Info */}
                            <motion.div
                            ...
                            >
                                ...
                                <div className="bg-gradient-to-br from-red-50 to-pink-50 rounded-2xl p-6 border border-red-200 text-center">
                                    <p className="text-gray-700 font-semibold mb-2">Attendance Percentage</p>
                                    <motion.div
                                    ...
                                    {attendancePercentage < 80 && (
                                        <motion.div
                                            initial={{ opacity: 0 }}
                                            animate={{ opacity: 1 }}
                                            className="bg-red-100 text-red-700 rounded-lg p-3 text-sm font-semibold flex items-start gap-2 mt-4"
                                        >

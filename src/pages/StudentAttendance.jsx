            ...
            >
                ...
                <div className="bg-white/60 backdrop-blur-lg shadow-xl rounded-3xl max-w-4xl w-full mx-auto px-8 py-6 relative z-20">
                    ...
                    <div className="flex w-full justify-between items-center mb-6 px-2">
                        ...
                        <span className="font-mono text-indigo-600 text-2xl font-bold">
                            {marked}/{total}
                        </span>
                    </div>
                    ...
                    {loading ? (
                        ...
                        <AnimatePresence>
                            <motion.div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mt-6">
                                {filtered.map((s, i) => (
                                    <motion.div
                                        key={s.id}
